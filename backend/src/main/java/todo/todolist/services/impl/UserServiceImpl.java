...
import todo.todolist.repositories.UserRepository;
import todo.todolist.services.UserService;
import todo.todolist.validators.UserValidator;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDto findById(Long id) {
        ...
        return userRepository.findById(id).map(UserDto::fromEntity)
                .orElseThrow(
                        () -> new EntityNotFoundException("No user found with ID = " + id, ErrorCodes.USER_NOT_FOUND));
    }
